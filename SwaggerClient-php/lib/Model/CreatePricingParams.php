...
/**
 * CreatePricingParams Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CreatePricingParams implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreatePricingParams';
    ...
    /**
     * Sets pricing_id
     * @param int $pricing_id Pricing plan code
     * @return $this
     */
    ...
    /**
     * Sets reason
     * @param string $reason Reason this pricing plan is added to the subaccount
     * @return $this
     */
    ...
    /**
     * Sets expire_date
     * @param int $expire_date Pricing plan expiration time in UNIX format. Disregard or set it to null for plan which never expires
     * @return $this
     */
